"""
Integration test of all IMERS agents.
"""
...
ok("confidence",     assessment.get("classification_confidence", "n/a"))
...
print(f"  Top hotspot  : {report['hotspots'][0].get('cell_id') if report.get('hotspots') else 'none'}")
