"""
  Runs every N minutes (default: 60). Computes Hotspot map, 7-day incident forecast and response time KPIs
...
class AnalysisRunner:
    ...
    def refresh_dashboard(self) -> dict:
        """
        Compute dashboard analytics and store in cache.
    ...
    def start_scheduler(self, interval_minutes: int = 60) -> None:
        ...
        every N minutes and on startup.
    ...
    def annotate_incident(
        ...
        """
        Gives a completed incident historical context.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="IMERS Analysis Runner",
